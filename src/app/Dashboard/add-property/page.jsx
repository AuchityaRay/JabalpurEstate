...
const ImageUploader = () => {
  ...
  const handleAddProperty = async (e) => {
    ...
    const propertyData = {
      ...
      category_id:parseInt(categories?.map((category) => category.id)),
      //  e.target.property_category.value,
    ...
    try {
      // Send a POST request to the property creation endpoint
      ...
      if (response.data && response.data.status === 'success') {
        ...
        setErrorMessage('Property creation failed. Please try again later.');
      }
    } catch (error) {
      if (error.response && error.response.data) {
        const errorMessage = error.response.data.message;
  ...
  return (
    <>
      <div className="w-full h-fit bg-white my-8 rounded-md shadow-xl font-opensans">
        <form className="flex flex-col space-y-5 p-5" onSubmit={handleAddProperty}>
          ...
          <div className="flex flex-col space-y-3 w-full">
            ...
            <input
              className="outline-gray-200 rounded-lg bg-gray-100 p-5"
              name="property_title"
              placeholder=""
          ...
          <div className="grid lg:grid-cols-2 md:grid-cols-1  gap-4  ">
            <div className="flex flex-col space-y-3 w-full">
              ...
              <textarea name="property_address" className="outline-gray-200 rounded-lg
               bg-gray-100 p-5"  />
            </div>
            <div className="flex flex-col space-y-3 w-full">
              <label className="text-gray-800 font-semibold ">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    ...
    <div className="flex flex-col space-y-3 w-full">
            ...
            <div className="input-container ">
              <input
                type="text"
                className=" rounded-xl h-14 bg-gray-100 p-5 w-full outline-gray-200"
                placeholder="Type amenity to add"
                value={inputValue}
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-1  gap-4 p-2 ">
            <div className="flex flex-col space-y-3 w-full">
              ...
              <input
                type="text"
                className="outline-gray-200 rounded-xl h-12 bg-gray-100 p-5"
                placeholder="" name="property_area" 
            ...
            <div className="flex flex-col space-y-3 w-full">
              ...
              <input
                type="number"
                className="outline-gray-200 rounded-xl h-12 bg-gray-100 p-5"
                placeholder="" name="property_plot_area"   
              />
            </div>
            <div className="flex flex-col space-y-3 w-full">
              <label className="text-gray-800 font-semibold ">
              ...
              <input
                type="number"
                className="outline-gray-200 rounded-xl h-12 bg-gray-100 p-5"
                placeholder="" name="property_constructed_area" 
            ...
            <div className="flex flex-col space-y-3 w-full">
              ...
              <input
                type="number"
                className="outline-gray-200 rounded-xl h-12 bg-gray-100 p-5"
                placeholder="" name="property_bedrooms"  
              />
            </div>
            <div className="flex flex-col space-y-3 w-full">
              <label className="text-gray-800 font-semibold ">
              ...
              <input
                type="number"
                className="outline-gray-200 rounded-xl h-12 bg-gray-100 p-5"
                placeholder="" name="property_bathroom" 
            ...
            <div className="flex flex-col space-y-3 w-full">
              ...
              <input
                type="number"
                className="outline-gray-200 rounded-xl h-12 bg-gray-100 p-5"
                placeholder="" name="property_carparking"
            ...
            <div className="flex flex-col space-y-3 w-full">
              ...
              <div class="currency-wrap ">
                ...
                <input
                  type="number"
                  className="outline-gray-200 rounded-xl h-12 w-full  bg-gray-100 p-5"
                  name="seller_price"
                  placeholder="" 
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-1  gap-4 p-2 ">
            <div className="flex flex-col space-y-3 w-full">
              <label className="text-gray-800 font-semibold ">Owner Name</label>
              <input
                className="outline-gray-200 rounded-xl h-12  bg-gray-100 p-5"
            ...
            <div className="flex flex-col space-y-3 w-full">
              ...
              <input
                type="email"
                className="outline-gray-200 rounded-xl h-12 bg-gray-100 p-5"
                placeholder="" name="property_email"
            ...
            <div className="flex flex-col space-y-3 w-full">
              ...
              <input
                type="number"
                className="outline-gray-200 rounded-xl h-12 bg-gray-100 p-5"
                placeholder="" name="property_contactnumber"
                
              />
            </div>
          </div>
          <div className='flex flex-row justify-between'>
            <button className="text-gray-800 font-semibold  bg-[#FFBD59] 
            hover:bg-yellow-500 w-64 rounded-full p-2">
              Add Property
            </button>
